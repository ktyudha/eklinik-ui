...
import { Snbp_Recapitulations } from "@services/school/alumni-snbp/interfaces/get-recapitulation-domestic-department.types";
...
const DepartementTableItem: FunctionComponent<Props> = ({ number, recap }) => {
  const navigate = useNavigate();
  const onHandleNavigate = () => {
    navigate(
      `/school/alumni-snbp/recapitulation/${recap.department_id.toLowerCase()}`,
      {
        state: {
          location: "domestic",
          type: "department",
...
export default DepartementTableItem;
