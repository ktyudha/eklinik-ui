...
import useGetRecapDomesticDepartment from "@services/school/alumni-snbp/hooks/useGetRecapDomesticDepartment";
import DepartementTableItem from "./DepartementTableItem";
import DepartementTableSkeleton from "./DepartementTableSkeleton";
...
const DepartementTable: FunctionComponent = () => {
  ...
  const {
    ...
    setPageNum,
    setYear,
  } = useGetRecapDomesticDepartment(snbpFilterYear);
        ...
        <TableBody>
          {loading || !recapitulations ? (
            ...
            recapitulations?.map((recap, idx) => {
              ...
              return (
                <DepartementTableItem
                  key={`departement-table-item-${idx}`}
                  number={number}
                  recap={recap}
                />
              );
