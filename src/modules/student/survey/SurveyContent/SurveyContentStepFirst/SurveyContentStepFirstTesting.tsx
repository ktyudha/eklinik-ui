...
const SurveyContentStepFirstTesting: FunctionComponent<Props> = ({
  groups
}) => {
  const {
    student,
                    ...
                    <div className='flex flex-col gap-3 py-4 px-5'>
                      {group.group_questions.map((groupQuestion, idx) => {
                        return (
                          ...
                          // />
                          <QuestionItem
                            key={`question-item-${groupQuestion.id}-${idx}`}
                            question={groupQuestion.question}
                          />
                        )
                      })}
...
export default SurveyContentStepFirstTesting